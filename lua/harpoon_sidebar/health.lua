--- Make sure `harpoon_sidebar` will work as expected.
---
...
local say_constant = require("harpoon_sidebar._commands.hello_world.say.constant")
local tabler = require("harpoon_sidebar._core.tabler")
local texter = require("harpoon_sidebar._core.texter")

local _LOGGER = logging_.get_logger("harpoon_sidebar.health")
...
---
---@param data harpoon_sidebar.Configuration All of the user's fallback settings.
...
---
---@param command string A supported `harpoon_sidebar` command. e.g. `"hello_world"`.
---@return string[] # All found issues, if any.
---
...
---
---@param data harpoon_sidebar.LoggingConfiguration The user's logger settings.
...
---
---@param data harpoon_sidebar.Configuration? All extra customizations for this plugin.
---@return string[] # All found issues, if any.
---
function M.get_issues(data)
    if not data or vim.tbl_isempty(data) then
        data = configuration_.resolve_data(vim.g.harpoon_sidebar_configuration)
    end
...
--- Make sure `data` will work for `harpoon_sidebar`.
---
---@param data harpoon_sidebar.Configuration? All extra customizations for this plugin.
---
function M.check(data)
    ...
    if vim.tbl_isempty(issues) then
        vim.health.ok("Your vim.g.harpoon_sidebar_configuration variable is great!")
    end
